...
from src.g import standardize_rope_params, rope_config_validation, RopeParameters
from src.transformer import _get_optim
...
class Qwen3ForCausalLM(Qwen3PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        logits = self.lm_head2(hidden_states)
